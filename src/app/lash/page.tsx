...
export const metadata: Metadata = {
  title: 'AgendaPRO para Lash Designers — Agenda, Ficha de Anamnese e Comissão',
  description: 'Sistema completo para lash designer: agenda online pelo link da bio, ficha de anamnese com mapping e termo assinado, pacote de manutenção com saldo automático e comissão calculada sozinha. R$67/mês, sem setup, 7 dias de garantia.',
  openGraph: {
    title: 'AgendaPRO para Lash Designers',
    description: 'Agenda online para lash designer. Anamnese digital com mapping, pacote de manutenção, comissão automática e lembrete de retoque.',
  },
}
...
/* ═══════════════════════════════════════════════════════════
   ...
   Persona: lash designer / manicure, 22-40 anos.
   Geralmente solo ou com 1 auxiliar. Trabalha em casa,
   espaço alugado ou salão parceiro.
   Serviços: volume russo, volume brasileiro, alongamento,
   lash lifting, manutenção. Aplicação de 1h30-3h.
...
const DORES = [
  {
    ...
    detalhe: 'Você tá no meio de um volume russo e o celular vibra 8 vezes. "Tem horário?", "Quanto é o gel?", "Pode sábado?". Responde depois e perde a cliente.',
    accent: '#C4B5FD',
    stat: '15+',
    statLabel: 'DMs/dia pra agendar',
  },
  {
    titulo: 'Falta em aplicação de 2h30',
    detalhe: 'Volume russo, R$180, 2h30 de maca reservada. A cliente sumiu. Sem aviso, sem reposição. Você ficou parada olhando pra agenda vazia.',
    accent: '#8B5CF6',
    stat: 'R$180',
...
const MOTORES = [
  { Icon: IconBrain,   tag: 'Anti-falta',     titulo: 'Lembrete que salva sua sessão',        desc: 'Lembrete automático por e-mail na véspera do horário. Confirma ou avisa que não vem. Você sabe se vai ter cliente antes de separar o material.', color: '#C4B5FD', stat: 'D-1', statLabel: 'lembrete por e-mail' },
  { Icon: IconTrophy,  tag: 'Ranking',         titulo: 'Google mostra seu trabalho primeiro',  desc: 'Depois do atendimento, a cliente ganha pontos pra avaliar no Google. Sua nota sobe e quem pesquisa "lash designer perto de mim" te acha.',  color: '#F59E0B', stat: '5★', statLabel: 'avaliação no Google' },
  ...
  { Icon: IconGift,    tag: 'Reativação',        titulo: 'Cliente fiel volta a aparecer',        desc: 'Cliente que ficou 40+ dias sem manutenção é detectada sozinha — o cupom sai pronto e você envia no WhatsApp com 1 clique.', color: '#A78BFA', stat: '40d', statLabel: 'sem manutenção' },
]

const TIMELINE = [
  { hora: '08:00', titulo: 'Você acorda e já tem cliente marcada',          detalhe: 'Larissa agendou volume brasileiro às 23h pelo link na bio. O AgendaPRO confirmou e programou lembrete pra véspera.' },
  ...
  { hora: '15:00', titulo: 'Atendendo sem interrupção',                     detalhe: 'Enquanto você aplica na Bianca, 2 clientes novas agendaram pelo link. Sem DM. Sem WhatsApp. Sem parar a unha.' },
...
const NAIL_FAQS: FAQItem[] = [
  {
    q: 'Tem ficha de anamnese pra cílios?',
    a: 'Tem, e é a mais completa que existe nessa faixa de preço. Alergia a cola e cosmético, uso de lente de contato, glaucoma, blefarite, gestante, se dorme de lado — as perguntas já vêm prontas. Você desenha o mapping com o dedo na tela, salva curvatura, espessura e efeito, e registra marca e lote da cola. Se a cliente reagir meses depois, você abre a ficha e mostra exatamente o que usou.',
  },
  {
    q: 'A cliente assina o termo de responsabilidade?',
    a: 'Assina na tela, com o dedo. O termo autoriza o procedimento e, se ela quiser, o uso da foto no seu portfólio. Fica salvo junto da ficha dela — sem papel pra guardar e sem procurar depois.',
  },
  {
    q: 'Consigo controlar a manutenção de 21 dias?',
    a: 'Consegue. Você vende o pacote de retoques e o sistema controla o saldo sozinho: quantos ela já fez, quantos faltam. E a cliente recebe lembrete do horário sem você precisar puxar conversa na DM.',
  },
  {
  ...
  {
    q: 'Quanto custa?',
    a: 'Solo R$ 67/mês (admin + 1 colaborador) — ideal pra lash designer que trabalha sozinha. Sem setup, sempre · preço fixo. Sem fidelidade, garantia de 7 dias. Se você tiver equipe, o plano Equipe (até 5 profissionais) sai R$ 97/mês.',
  },
  {
  ...
  },
  {
    ...
    a: '100%. Painel, agenda, financeiro — tudo no celular. A maioria das lash designers nem usa computador. Funciona igual.',
  },
  {
    q: 'Quem dá suporte?',
    ...
    <div className="rounded-xl overflow-hidden" style={{ background: '#fff', border: '1px solid #F1F3F4', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
      ...
      <div className="p-2 space-y-1">
        {[
          ...
          { nome: 'Jéssica', msg: 'Vc faz volume russo? Queria agendar', hora: '10:18' },
    ...
    <div className="rounded-xl overflow-hidden" style={{ background: '#fff', border: '1px solid #F1F3F4', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-bold text-white" style={{ background: '#C4B5FD' }}>C</div>
          <div>
  ...
  return (
    <main className="relative overflow-hidden" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)' }}>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(90deg, #831843 0%, #C4B5FD 50%, #8B5CF6 100%)',
        ...
        <div className="container px-4 flex items-center justify-between h-14 sm:h-16">
          <Link href="/" className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <span
              ...
              style={{ background: 'rgba(244,114,182,0.15)', color: '#C4B5FD', border: '1px solid rgba(244,114,182,0.3)' }}
            >
              <IconNailPolish size={10} /> Lash
            </span>
          </Link>
          <Link
            href="/cadastro"
            ...
            <SectionReveal className="flex flex-col items-center lg:items-start text-center lg:text-left gap-5 sm:gap-6 lg:gap-7">
              ...
              <div className="pill inline-flex items-center gap-2 text-[10px] sm:text-xs">
                <span
                  ...
                  style={{ background: 'linear-gradient(135deg, #C4B5FD, #A78BFA)', color: '#fff', letterSpacing: '0.05em' }}
                >
                  R$ 67
                </span>
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-300 max-w-2xl leading-relaxed">
                Cliente vê o link na bio e agenda sozinha. Recebe lembrete antes da aplicação e não falta. Cancelou o volume russo de R$ 180? A fila preenche em 3 minutos. E a ficha dela — anamnese, mapping, a cola que você usou — abre junto do horário. <strong className="text-white">Você fica nos olhos. O resto o sistema cuida.</strong>
              </p>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <div className="inline-flex items-center gap-2 px-3 py-2 rounded-xl" style={{ background: 'rgba(236,72,153,0.10)', border: '1px solid rgba(236,72,153,0.30)' }}>
                  <span className="flex items-center justify-center w-7 h-7 rounded-lg flex-shrink-0" style={{ background: 'rgba(236,72,153,0.20)', color: '#A78BFA' }}>
                    <IconCash size={14} />
                  </span>
                ...
                <div className="inline-flex items-center gap-2 px-3 py-2 rounded-xl" style={{ background: 'rgba(244,114,182,0.08)', border: '1px solid rgba(244,114,182,0.25)' }}>
                  <span className="flex items-center justify-center w-7 h-7 rounded-lg flex-shrink-0" style={{ background: 'rgba(244,114,182,0.18)', color: '#C4B5FD' }}>
      ...
      {/* ═══════════ 1.5 GENTE REAL — manicure trabalhando em cílios ═══════════ */}
          ...
          <SectionReveal>
            <div
              ...
              style={{
                ...
                boxShadow: '0 30px 80px -30px rgba(236,72,153,0.35)',
              }}
            >
              <div className="grid md:grid-cols-2 items-stretch min-h-[320px] md:min-h-[420px]">
                <div className="relative h-64 md:h-auto">
                  <Image
                    src="/images/lp/nail.jpg"
                    alt="Lash designer aplicando extensão de cílios em cliente"
                    fill
                  ...
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(135deg, rgba(236,72,153,0.18) 0%, transparent 60%)',
                    }}
                  />
                  <div
                    aria-hidden
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, #1f0a1a 0%, #15041a 60%, #06030c 100%)',
                  }}
                >
                  <div
                  ...
                  >
                    ...
                    Feito pra lash designer
                  </div>

                  <h2 className="text-white font-black mb-3 leading-tight" style={{ fontSize: 'clamp(1.4rem, 4vw, 2.2rem)' }}>
                    3 semanas adiante,<br />
                    <span style={{ color: '#A78BFA' }}>100% lotadas</span>.
                  </h2>

                  <p className="text-slate-300 text-sm sm:text-base leading-relaxed mb-5">
                    Cliente de cílios é fiel por necessidade: sem retoque em 21 dias, o trabalho cai. O AgendaPRO segura essa janela — quando alguém sai, a próxima entra na fila automaticamente. Sua agenda fica cheia 3 semanas pra frente sozinha.
                  </p>

                  <div className="grid grid-cols-3 gap-2 sm:gap-3 mt-2">
                    {[
                      { kpi: '96%', label: 'Ocupação 3 semanas' },
                      { kpi: '0', label: 'Furo da fila' },
                      { kpi: '2-3 sem', label: 'Volta da cliente' },
                    ].map((s) => (
                      <div
                        key={s.label}
                      ...
                      >
                        <div className="font-mono font-black text-base sm:text-lg leading-none" style={{ color: '#A78BFA' }}>
                          {s.kpi}
                        </div>
                  ...
                  {i === 0 && (
                    <div className="rounded-xl p-3 space-y-1.5" style={{ background: 'rgba(8,11,24,0.6)', border: `1px solid ${m.color}25` }}>
                      <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg" style={{ background: 'rgba(244,114,182,0.08)', border: '1px solid rgba(244,114,182,0.2)' }}>
                        <span className="w-5 h-5 rounded-md inline-flex items-center justify-center text-white flex-shrink-0" style={{ background: '#C4B5FD' }}><IconMail size={11} strokeWidth={2} /></span>
                  ...
                  {i === 1 && (
                    <div className="rounded-xl p-3" style={{ background: 'rgba(8,11,24,0.6)', border: `1px solid ${m.color}25` }}>
                      <div className="flex items-center gap-2.5 mb-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-[11px] font-bold text-white">Studio Lash Bruna</div>
      ...
      <section className="relative py-16 sm:py-20 lg:py-28">
        <div className="container max-w-6xl px-4">
          ...
          <SectionReveal><ComparisonMiniUIs variant="lash" /></SectionReveal>
        </div>
      </section>
      ...
      <FichaAnamnese variant="lash" />

      {/* ═══════════ 4.55 COMANDA · PAGAMENTO · COMISSAO ═══════════ */}
      <ComandaComissao variant="lash" />

      {/* ═══════════ 4.6 VENDAS + ESTOQUE ═══════════ */}
      <VendasEstoque variant="lash" />

      {/* ═══════════ 4.7 PACOTES ═══════════ */}
      <Pacotes variant="lash" />
      ...
      <section className="relative py-16 sm:py-20 lg:py-28">
        <div className="container px-4">
          ...
          <SectionReveal><OnboardingSteps variant="lash" /></SectionReveal>
        </div>
      </section>
        ...
        <div className="container px-4">
          <SectionReveal className="text-center mb-8 sm:mb-10 max-w-3xl mx-auto">
            <div className="pill mb-5 sm:mb-6 inline-flex items-center gap-2 text-xs sm:text-sm">
              ...
              <span>Plano pra lash designer</span>
            </div>
            <h2 className="text-white font-black mb-3 sm:mb-4 leading-tight" style={{ fontSize: 'clamp(1.8rem, 5vw, 3rem)' }}>
          ...
          {/* 4 modalidades de pagamento (cartão + 3 PIX) — default Solo (lash costuma trabalhar sozinha) */}
          <SectionReveal>
        ...
        <div className="container relative max-w-4xl px-4">
          <SectionReveal className="text-center">
            ...
            <h2 className="text-white font-black mb-5 sm:mb-6 leading-[1.05]" style={{ fontSize: 'clamp(2rem, 7vw, 4rem)' }}>
              Enquanto você lê isso,<br />alguém pesquisou<br /><span className="text-gradient">&quot;lash designer perto de mim&quot;</span><br />e agendou com outra.
            </h2>
