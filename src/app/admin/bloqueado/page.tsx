...
export default async function AdminBloqueadoPage() {
  ...
  const waSetupMessage =
    reason === 'pending_payment'
      ? `Olá! Criei minha conta no AgendaPRO pra ${business.name} (Plano ${planLabel}). Quero pagar o setup de ${planSetup} via PIX. Qual o próximo passo?`
    : reason === 'refunded'
          ...
          {reason === 'pending_payment' && (
            <>
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-emerald-300 text-base leading-none">{planSetup}</p>
                    <p className="text-[10px] text-slate-500 uppercase tracking-wider">setup</p>
                    <p className="text-sm text-white mt-1.5">+ {planMonthly}/mês</p>
                  </div>
                </div>
              ...
              >
                ...
                Pagar setup ({planSetup}) pelo WhatsApp
              </a>
