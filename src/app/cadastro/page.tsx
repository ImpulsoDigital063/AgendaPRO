...
export default function CadastroPage() {
  ...
  const waMessage = encodeURIComponent(
    `Oi! Acabei de colocar minha agenda online. Agora dá pra agendar comigo direto por aqui: ${publicUrl}. Bora marcar?`
  )
      ...
      >
        <div className="w-full max-w-sm relative">
          ...
          <div className="rounded-3xl p-7 text-center" style={cardStyle}>
            ...
            <h2 className="text-xl font-bold text-white mb-1">Pronto! Sua agenda tá no ar.</h2>
            <p className="text-sm text-slate-400 mb-5">
              Agora é mandar o link pros seus clientes começarem a agendar.
            </p>

            <div
              className="rounded-2xl p-3 mb-3 text-left"
              style={{
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <p className="text-sm text-emerald-300 font-medium truncate flex-1">{publicUrl}</p>
                <button
                  type="button"
                  onClick={handleCopyLink}
                  className="text-xs font-semibold px-2.5 py-1.5 rounded-lg flex-shrink-0 transition-colors"
                  style={{
            ...
            <a
              ...
              className="w-full py-3.5 rounded-xl font-bold text-white text-sm transition-all flex items-center justify-center gap-2 mb-2"
              style={{
