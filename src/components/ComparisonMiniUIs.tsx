...
function SmartAgendaCard({ data }: { data: VariantData }) {
  ...
  const automacoes = [
    ...
    { ico: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1111.21 3a7 7 0 009.79 9.79z"/></svg>, t: 'Anti-falta por e-mail na véspera' },
  ]
