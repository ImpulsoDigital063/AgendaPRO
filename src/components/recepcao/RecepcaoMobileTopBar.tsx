...
/**
 * RecepcaoMobileTopBar · top bar com hambúrguer pra /recepcao em < lg.
 *
 * Existe porque o dock do celular cabe 5 itens e o balcão tem 11: Comandas,
 * Produtos, Pacotes e Marcar ficavam INALCANÇÁVEIS no mobile — a recepção
 * conseguia ver a agenda mas não fechava a conta da cliente pelo celular.
 * Espelha o menu do painel da profissional e do admin (Eduardo, 26/08:
 * "tudo que tem no desktop tem que ter no mobile").
 */
