...
export default function AgendarModal({
  ...
  async function handleSave() {
    ...
    // (agendamento futuro) segue usando a duração. (Eduardo 09/06 · estendido pra
    // jaConcluido 24/07 · resgate marcado "já atendi" batia no no_overlap.)
    // A duração real do serviço continua salva em appointment_services.
    const endTime = (balcao || jaConcluido) ? time : addMinutesToTime(time, totalDuration)
