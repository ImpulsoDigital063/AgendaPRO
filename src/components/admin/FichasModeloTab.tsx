...
const PRESETS: Preset[] = [
  {
    ...
    description: 'Ficha de cílios completa · avaliação de saúde + procedimento + mapeamento fio a fio (desenho) + termo · espelha a ficha de papel',
    fields: [
      // ── Avaliação (saúde) ──────────────────────────────────────────
      { name: 'gestante', label: 'Gestante?', type: 'checkbox' },
      { name: 'lactante', label: 'Lactante?', type: 'checkbox' },
      { name: 'diabetes', label: 'Diabetes?', type: 'checkbox' },
      { name: 'medicamento', label: 'Faz uso de medicamento?', type: 'checkbox' },
      { name: 'medicamento_qual', label: 'Se sim, qual medicamento?', type: 'text' },
      { name: 'tireoide', label: 'Disfunções da tireoide?', type: 'checkbox' },
      { name: 'circulatorio', label: 'Problema circulatório?', type: 'checkbox' },
      { name: 'hipertensao', label: 'Hipertensão?', type: 'checkbox' },
      { name: 'hormonal', label: 'Distúrbio hormonal?', type: 'checkbox' },
      { name: 'hormonal_qual', label: 'Se sim, qual distúrbio hormonal?', type: 'text' },
      { name: 'alergia', label: 'Alergia a algum cosmético?', type: 'checkbox' },
      { name: 'alergia_qual', label: 'Se sim, qual alergia?', type: 'text' },
      { name: 'olhos_recente', label: 'Fez algum procedimento nos olhos recentemente?', type: 'checkbox' },
      { name: 'ocular', label: 'Possui glaucoma, blefarite ou problema ocular?', type: 'checkbox' },
      { name: 'ocular_qual', label: 'Se sim, qual problema ocular?', type: 'text' },
      { name: 'tratamento_medico', label: 'Está em tratamento médico?', type: 'checkbox' },
      { name: 'dermatologico', label: 'Faz tratamento dermatológico recente?', type: 'checkbox' },
      { name: 'dorme_lado', label: 'Dorme de lado?', type: 'checkbox' },
      { name: 'observacao_saude', label: 'Algo que julgue necessário informar antes do procedimento', type: 'freetext' },
      // ── Procedimento ───────────────────────────────────────────────
      ...
      { name: 'estilo', label: 'Estilo', type: 'text' },
      ...
      { name: 'modelo_fios', label: 'Modelo dos fios', type: 'text' },
      { name: 'espessura', label: 'Espessura', type: 'text' },
      { name: 'adesivo', label: 'Adesivo / Cola', type: 'text' },
      { name: 'curvatura', label: 'Curvatura', type: 'text' },
      { name: 'lifting', label: 'Lash Lifting?', type: 'checkbox' },
      { name: 'permanente', label: 'Permanente?', type: 'checkbox' },
      { name: 'marca', label: 'Marca', type: 'text' },
      { name: 'tamanho_bob', label: 'Tamanho do Bob', type: 'text' },
      { name: 'tintura', label: 'Tintura?', type: 'checkbox' },
      { name: 'tintura_cor', label: 'Cor da tintura', type: 'text' },
      { name: 'tempo_acao', label: 'Tempo de ação', type: 'text' },
      { name: 'valor', label: 'Valor (R$)', type: 'number' },
      { name: 'data_manutencao', label: 'Data da manutenção', type: 'date' },
      { name: 'observacoes', label: 'Observações livres', type: 'freetext' },
      { name: 'termo', label: 'Autorizo o procedimento e o registro de antes/depois para documentação; comprometo-me com os cuidados pós; declaro verdadeiras as informações acima, isentando a profissional por dados omitidos.', type: 'checkbox', required: true },
    ],
  },
  {
    category: 'Anamnese',
