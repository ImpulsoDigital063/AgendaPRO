...
/**
 * Mascara progressiva pra inputs em digitacao. Diferente de maskPhone
 * (que so formata se length canonico), esta formata durante typing —
 * cliente ve "(63) 9" enquanto digita 639, etc. Usar em onChange.
 */
